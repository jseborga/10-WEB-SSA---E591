  ...
  try {
    ...
    const project = await db.project.update({
      ...
      data: {
        ...
        mainImageAlt: normalizeOptionalString(mainImageAlt),
        mainImageCaption: normalizeOptionalString(mainImageCaption),
        ...
        seoTitle: normalizeOptionalString(seoTitle),
        seoDescription: normalizeOptionalString(seoDescription),
        seoKeywords: normalizeOptionalString(seoKeywords),
        projectTags: normalizeOptionalString(projectTags),
        galleryAnnotations: normalizeOptionalString(galleryAnnotations),
        galleryMobileAnnotations: normalizeOptionalString(galleryMobileAnnotations),
