...
export function buildLeadSalesInstructions(language: string) {
  if (language === 'en') {
    return [
      ...
      'If any of these are missing, ask for them naturally, one at a time: full name, phone/WhatsApp, email, service needed, project location, and a short project idea.',
  ...
  if (language === 'pt') {
    return [
      ...
      'Se faltarem dados, peça naturalmente, um de cada vez: nome completo, telefone/WhatsApp, email, serviço desejado, localização do projeto e uma ideia breve do projeto.',
  ...
  return [
    ...
    'Si faltan datos, pide naturalmente, uno por vez: nombre completo, teléfono o WhatsApp, correo, servicio que necesita, ubicación del proyecto y una idea breve del proyecto.',
  ...
  const prompt =
    input.language === 'en'
      ? [
          ...
          'JSON keys: name, email, phone, serviceType, projectType, projectLocation, projectIdea, summary, needsHuman.',
          input.transcript,
        ].join('\n\n')
      : input.language === 'pt'
        ? [
            ...
            'Chaves JSON: name, email, phone, serviceType, projectType, projectLocation, projectIdea, summary, needsHuman.',
            input.transcript,
          ].join('\n\n')
        : [
            ...
            'Claves JSON: name, email, phone, serviceType, projectType, projectLocation, projectIdea, summary, needsHuman.',
            input.transcript,
          ].join('\n\n')
  ...
  const prompt =
    input.language === 'en'
      ? [
          ...
          'It must capture name, phone/WhatsApp, email, service needed, project location, and project idea.',
      ...
      : input.language === 'pt'
        ? [
            ...
            'Ele deve capturar nome, telefone/WhatsApp, email, serviço desejado, localização do projeto e ideia do projeto.',
        ...
        : [
            ...
            'Debe capturar nombre, teléfono o WhatsApp, correo, servicio que necesita, ubicación del proyecto e idea del proyecto.',
